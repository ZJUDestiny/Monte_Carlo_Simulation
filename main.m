...
energy_res_back=zeros(1,2000);
energy_res_forward=zeros(1,2000);
...
figure(4);subplot(131);plot([1:2000],energy_his_back);title('back');axis([-100,2100,0,1.2*max(energy_his_back)]);xlabel('R/nm');
figure(4);subplot(132);plot([1:2000],energy_his_forward);title('forward');axis([-100,2100,0,1.2*max(energy_his_forward)]);xlabel('R/nm');
figure(4);subplot(133);plot([1:2000],energy_his_back+energy_his_forward);title('all');axis([-100,2100,0,1.2*max(energy_his_back+energy_his_forward)]);xlabel('R/nm');
